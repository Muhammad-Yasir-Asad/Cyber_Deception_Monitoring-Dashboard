-- ============================================================
-- SECUREBANK HONEYPOT — FINAL UNIFIED SCHEMA
...
-- severity is INTEGER 1-10 matching friend schema (not LOW/MEDIUM/HIGH/CRITICAL string)
-- attack_type uses our lowercase values: sqli, xss, bruteforce, traversal
